...
|------|-----|------|
| **伤害 (stDa)** | 14 | 单次命中基础伤害 |
| **射速 (stRa)** | 74.1 发/分钟 | 每分钟射击次数 |
| **射程 (stDi)** | 14 | 有效射程评分 |
| **精度 (stDe)** | 21 | 精准度评分 |
| **换弹速度 (stRt)** | 0.133 | 换弹速率系数 |
| **弹匣容量 (am)** | 8 发 | 单弹匣装弹量 |
| **备弹总量 (amt)** | 32 发 | 含弹匣的总弹药 |
...
|--------|---------|-----------|-----------|-----------|-----------|-----------|
| 21 (基础版) | 4 | 14 | 74.1 | 14 | 21 | 430 || 250 (升级版) | 6 | 15 | 74.1 | 14 | 21 | 460 |
| 251 (升级版) | 8 | 16 | 74.1 | 14 | 21 | 500 |
| 252 (升级版) | 10 | 17 | 74.1 | 14 | 21 | 550 |
| 253 (升级版) | 10 | 18 | 74.1 | 14 | 21 | 600 |
| 254 (升级版) | 16 | 20 | 82.8 | 12 | 100 | 485 |
