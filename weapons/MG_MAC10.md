...
| 属性 | 值 | 说明 |
|------|-----|------|
| **伤害 (stDa)** | 400 | 单次命中基础伤害 |
| **射速 (stRa)** | 1000 发/分钟 | 每分钟射击次数 |
| **射程 (stDi)** | 28 | 有效射程评分 |
| **精度 (stDe)** | 29 | 精准度评分 |
| **换弹速度 (stRt)** | 0.333 | 换弹速率系数 |
| **弹匣容量 (am)** | 35 发 | 单弹匣装弹量 |
| **备弹总量 (amt)** | 105 发 | 含弹匣的总弹药 |
...
|--------|---------|-----------|-----------|-----------|-----------|-----------|
| 1 (基础版) | 15 | 400 | 1000 | 28 | 29 | 4490 || 1000 (升级版) | 15 | 450 | 1000 | 28 | 29 | 4710 |
| 1001 (升级版) | 15 | 550 | 1000 | 28 | 29 | 4960 |
| 1002 (升级版) | 15 | 650 | 1000 | 28 | 29 | 5240 |
| 1003 (升级版) | 18 | 750 | 1000 | 28 | 29 | 5560 |
| 1004 (升级版) | 24 | 850 | 1000 | 28 | 29 | 5920 |
