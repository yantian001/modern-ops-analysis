...
| 属性 | 值 | 说明 |
|------|-----|------|
| **伤害 (stDa)** | 144 | 单次命中基础伤害 |
| **射速 (stRa)** | 51.1 发/分钟 | 每分钟射击次数 |
| **射程 (stDi)** | 130 | 有效射程评分 |
| **精度 (stDe)** | 100 | 精准度评分 |
| **换弹速度 (stRt)** | 0.233 | 换弹速率系数 |
| **弹匣容量 (am)** | 5 发 | 单弹匣装弹量 |
| **备弹总量 (amt)** | 15 发 | 含弹匣的总弹药 |
...
|--------|---------|-----------|-----------|-----------|-----------|-----------|
| 57 (基础版) | 6 | 144 | 51.1 | 130 | 100 | 980 || 440 (升级版) | 6 | 150 | 51.1 | 130 | 100 | 1050 |
| 441 (升级版) | 7 | 163 | 51.1 | 130 | 100 | 1140 |
| 442 (升级版) | 8 | 185 | 51.1 | 130 | 100 | 1230 |
| 443 (升级版) | 9 | 200 | 51.1 | 130 | 100 | 1330 |
| 444 (升级版) | 10 | 210 | 51.1 | 130 | 100 | 1440 |
