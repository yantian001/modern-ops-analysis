...
| 属性 | 值 | 说明 |
|------|-----|------|
| **伤害 (stDa)** | 280 | 单次命中基础伤害 |
| **射速 (stRa)** | 38.8 发/分钟 | 每分钟射击次数 |
| **射程 (stDi)** | 80 | 有效射程评分 |
| **精度 (stDe)** | 83 | 精准度评分 |
| **换弹速度 (stRt)** | 0.25 | 换弹速率系数 |
| **弹匣容量 (am)** | 7 发 | 单弹匣装弹量 |
| **备弹总量 (amt)** | 21 发 | 含弹匣的总弹药 |
...
|--------|---------|-----------|-----------|-----------|-----------|-----------|
| 111 (基础版) | 3 | 280 | 38.8 | 80 | 83 | 2770 || 610 (升级版) | 17 | 357 | 38.8 | 80 | 83 | 2920 |
| 611 (升级版) | 24 | 375 | 38.8 | 80 | 83 | 3080 |
| 612 (升级版) | 24 | 395 | 38.8 | 80 | 83 | 3250 |
| 613 (升级版) | 24 | 410 | 38.8 | 80 | 83 | 3440 |
| 614 (升级版) | 31 | 475 | 38.8 | 80 | 83 | 3650 |
