...
| 属性 | 值 |
|------|-----|
| **系统名称 (sn)** | SR_FN_Ballista |
| **武器ID (i)** | 2070 |
| **武器类型 (wt)** | SNIPER_RIFLE (狙击枪) |
| **稀有度 (rar)** | 史诗 (Epic) |
| **解锁等级 (nl)** | 无限制 |
| **综合威力 (stPo)** | 4950 |
...
| 属性 | 值 | 说明 |
|------|-----|------|
| **伤害 (stDa)** | 550 | 单次命中基础伤害 |
| **射速 (stRa)** | 37.5 发/分钟 | 每分钟射击次数 |
| **射程 (stDi)** | 100 | 有效射程评分 |
| **精度 (stDe)** | 100 | 精准度评分 |
| **换弹速度 (stRt)** | 0.333 | 换弹速率系数 |
| **弹匣容量 (am)** | 15 发 | 单弹匣装弹量 |
| **备弹总量 (amt)** | 60 发 | 含弹匣的总弹药 |
...
|--------|---------|-----------|-----------|-----------|-----------|-----------|
| 2070 (基础版) | — | 550 | 37.5 | 100 | 100 | 4950 || 2071 (升级版) | 55 | 591 | 37.5 | 100 | 100 | 5150 |
| 2072 (升级版) | 55 | 646 | 37.5 | 100 | 100 | 5370 |
| 2073 (升级版) | 55 | 707 | 37.5 | 100 | 100 | 5610 |
| 2074 (升级版) | 55 | 774 | 37.5 | 100 | 100 | 5880 |
| 2075 (升级版) | 55 | 846 | 37.5 | 100 | 100 | 6170 |
| 2076 (升级版) | 55 | 926 | 37.5 | 100 | 100 | 6480 |
