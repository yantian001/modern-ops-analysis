...
| 属性 | 值 | 说明 |
|------|-----|------|
| **伤害 (stDa)** | 295 | 单次命中基础伤害 |
| **射速 (stRa)** | 600 发/分钟 | 每分钟射击次数 |
| **射程 (stDi)** | 50 | 有效射程评分 |
| **精度 (stDe)** | 110 | 精准度评分 |
| **换弹速度 (stRt)** | 0.5 | 换弹速率系数 |
| **弹匣容量 (am)** | 1 发 | 单弹匣装弹量 |
| **备弹总量 (amt)** | 11 发 | 含弹匣的总弹药 |
...
|--------|---------|-----------|-----------|-----------|-----------|-----------|
| 74 (基础版) | 17 | 295 | 600 | 50 | 110 | 2380 || 510 (升级版) | 17 | 320 | 600 | 50 | 110 | 2470 |
| 511 (升级版) | 17 | 330 | 600 | 50 | 110 | 2570 |
| 512 (升级版) | 17 | 335 | 600 | 50 | 110 | 2670 |
| 513 (升级版) | 24 | 335 | 600 | 50 | 110 | 2790 |
| 514 (升级版) | 24 | 335 | 600 | 50 | 110 | 2910 |
