...
| 属性 | 值 | 说明 |
|------|-----|------|
| **伤害 (stDa)** | 214 | 单次命中基础伤害 |
| **射速 (stRa)** | 40 发/分钟 | 每分钟射击次数 |
| **射程 (stDi)** | 100 | 有效射程评分 |
| **精度 (stDe)** | 86 | 精准度评分 |
| **换弹速度 (stRt)** | 0.25 | 换弹速率系数 |
| **弹匣容量 (am)** | 12 发 | 单弹匣装弹量 |
| **备弹总量 (amt)** | 48 发 | 含弹匣的总弹药 |
...
|--------|---------|-----------|-----------|-----------|-----------|-----------|
| 50 (基础版) | — | 214 | 40 | 100 | 86 | 2410 || 121 (升级版) | 25 | 320 | 49 | 150 | 100 | 618 |
| 410 (升级版) | 17 | 234 | 40 | 100 | 86 | 2530 |
| 411 (升级版) | 17 | 261 | 40 | 100 | 86 | 2660 |
| 412 (升级版) | 24 | 295 | 40 | 100 | 86 | 2800 |
| 413 (升级版) | 24 | 310 | 40 | 100 | 86 | 2960 |
| 414 (升级版) | 31 | 320 | 40 | 100 | 86 | 3130 |
